...
public class Person implements Serializable {
	...
	private @Valid EmergencyContactDetails emergencyContactDetails;
	...
	public Person(int personId, String candidateName, LocalDate dob, Long contactNo, Long whatsUpNo, Long aadharCardNo,
